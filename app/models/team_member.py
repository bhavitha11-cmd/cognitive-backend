...
class TeamMember(Base):
    ...
    is_primary_team: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    employee: Mapped["Employee"] = relationship("Employee", back_populates="team_assignments")
